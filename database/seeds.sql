...
-- =============================================================================
INSERT INTO products (id, name, description, category, price, stock, is_flash_sale, flash_sale_price, flash_sale_stock) VALUES
    -- FLASH SALE (5)
    (1, 'Smartwatch X100',
     ...
     'Elektronik', 1499000.00, 12, TRUE, 899000.00, 12),
    (2, 'Wireless Earbuds Pro',
     ...
     'Elektronik', 899000.00, 10, TRUE, 549000.00, 10),
    (3, 'Sneaker Run Ultralight',
     ...
     'Fashion', 799000.00, 20, TRUE, 429000.00, 20),
    (4, 'Tas Ransel Urban 30L',
     ...
     'Fashion', 499000.00, 15, TRUE, 299000.00, 15),
    (5, 'Smart TV LED 32 Inch',
     ...
     'Elektronik', 2999000.00, 18, TRUE, 1799000.00, 18),
    ...
    (6, 'Kemeja Oxford Premium',
     ...
     'Fashion', 249000.00, 100, FALSE, NULL, NULL),
    (7, 'Headphone ANC Silent',
     ...
     'Elektronik', 1299000.00, 80, FALSE, NULL, NULL),
    (8, 'Jam Tangan Classic',
     ...
     'Aksesoris', 699000.00, 60, FALSE, NULL, NULL),
    (9, 'Dompet Slim RFID',
     ...
     'Aksesoris', 179000.00, 75, FALSE, NULL, NULL),
    (10, 'Suplemen Vitamin C 1000mg',
     ...
     'Kesehatan', 85000.00, 90, FALSE, NULL, NULL),
    ...
    (11, 'Kabel USB-C Braided',
     ...
     'Elektronik', 99000.00, 3, FALSE, NULL, NULL),
